      ...
      <div className="footer-grid">
        <div className="footer-brand">
          ...
          <div className="footer-actions">
            ...
            <a href="https://www.linkedin.com/company/hive-automation-llp/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" title="LinkedIn" className="footer-action-icon">
