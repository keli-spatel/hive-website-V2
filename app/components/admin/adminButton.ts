...
export const adminButtonStyles = cva(
  "admin-button inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap border text-sm font-medium leading-none no-underline transition-colors outline-none focus-visible:border-[#00B0FF] focus-visible:ring-2 focus-visible:ring-[#00B0FF]/25 disabled:cursor-not-allowed disabled:opacity-60 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
